          ...
          <div className="max-w-6xl mx-auto px-4 sm:px-6">
            <div className="pt-32 pb-12 md:pt-40 md:pb-20">
              ...
              <div className="max-w-3xl mx-auto text-center pb-12">
                ...
                <h1 className="h2 font-cabinet-grotesk text-orange-300">
                  Join
                  <br />
              ...
              <div className="max-w-sm mx-auto">
                <form>
                  ...
                  <div className="flex flex-wrap items-center justify-between mt-6">
                    ...
                    <div className="ml-2">
                      <button className="btn text-orange-700 border border-orange-300 bg-white hover:bg-orange-100 w-full shadow-sm">
                        Join The Community
                      </button>
                    </div>
                  </div>
                  <div className="mt-5">
                    <label className="flex items-start">
                      ...
                      <span className="text-sm text-gray-500 ml-3">
                        I accept the{" "}
                        <a
                          className="underline hover:decoration-[#174054] underline-offset-2 hover:underline"
                          href="#0"
                        >
                          terms
                        </a>{" "}
