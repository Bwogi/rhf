          ...
          <div className="max-w-6xl mx-auto px-4 sm:px-6">
            <div className="pt-32 pb-12 md:pt-40 md:pb-20">
              ...
              <div className="max-w-3xl mx-auto text-center pb-12">
                ...
                <h1 className="h2 font-cabinet-grotesk">You've been invited to Join the Restoration House Fellowship</h1>
              </div>
              {/* Form */}
                ...
                <form>
                  <div className="flex flex-wrap mb-4">
                    <div className="w-full">
                      ...
                      <input id="email" type="email" className="form-input w-full text-gray-800" defaultValue="" required />
                    </div>
                  </div>
                  <div className="flex flex-wrap mb-4">
                    <div className="w-full">
                  ...
                  <div className="flex flex-wrap items-center justify-between mt-6">
                    <Link
                      className="font-medium text-sm sm:text-base text-[#077CB5] decoration-[#077CB5] decoration-2 underline-offset-2 hover:underline"
                      to="/signin"
                    >
                      Go to Login
                    </Link>
                    <div className="ml-2">
                      <button className="btn-sm text-white bg-[#077CB5] hover:bg-[#1d5977] shadow-sm">Join The Community</button>
                    </div>
                  </div>
                  <div className="mt-5">
                    <label className="flex items-start">
                      ...
                      <span className="text-sm text-gray-500 ml-3">
                        I accept the{' '}
                        <a className="underline hover:decoration-[#077CB5] underline-offset-2 hover:underline" href="#0">
                          terms
                        </a>{' '}
                        and{' '}
