        ...
        <div className="py-8 md:py-12">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center sm:justify-between mb-12 md:mb-6">
            <div className="shrink-0 mr-4">
              <Link className="inline-flex group mb-8 sm:mb-0" to="/" aria-label="logo">
            ...
            <form className="w-full max-w-sm">
              <div className="flex flex-col sm:flex-row justify-center max-w-xs mx-auto sm:max-w-none">
                ...
                <button className="btn-sm text-white bg-[#077CB5] hover:bg-[#1d5977] shadow-sm whitespace-nowrap" type="submit">
                  Join Newsletter
                </button>
              </div>
              {/* Success message */}
          ...
          <div className="text-center md:flex md:items-center md:justify-between mb-8 md:mb-6">
            ...
            <ul className="inline-flex mb-4 md:order-2 md:ml-4 md:mb-0">
              <li>
                <a
                  className="flex justify-center items-center text-[#077CB5] bg-blue-100 hover:text-white hover:bg-[#1d5977] rounded-full transition duration-150 ease-in-out"
                  href="#0"
                  aria-label="Twitter"
                >
            ...
            <div className="text-sm font-medium md:order-1 space-x-6 mb-2 md:mb-0">
              <a className="text-gray-500 decoration-[#077CB5] decoration-2 underline-offset-2 hover:underline" href="#about">
                About
              </a>
              <a className="text-gray-500 decoration-[#077CB5] decoration-2 underline-offset-2 hover:underline" href="#blog">
                Blog
              </a>
              <a className="text-gray-500 decoration-[#077CB5] decoration-2 underline-offset-2 hover:underline" href="#0">
                Privacy &amp; Terms
              </a>
            </div>
          </div>
          ...
          <div className="text-xs text-gray-400 text-center md:text-left">
            Some of the images, videos, and other content posted on the site
            ...
            <a className="font-medium text-blue-500 decoration-[#077CB5] underline-offset-2 hover:underline" href="#0">
              contact us
            </a>
            .
          </div>
