        ...
        <div className="pt-32 pb-12 md:pt-40 md:pb-20">
          ...
          <div className="relative max-w-xl mx-auto md:max-w-none text-center md:text-left flex flex-col md:flex-row">
            ...
            <div className="md:w-[640px]">
              ...
              >
                Celebrate{" "}
                {/* <span className="relative inline-flex text-[#174054]"> */}
                <span className="relative inline-flex text-[#D1D5DB]">
                  <svg
              ...
              >
                <div>
                  <Link
                    className="btn text-gray-700 bg-orange-100 border border-orange-100 hover:bg-orange-200 w-full shadow-sm"
