          ...
          <div className="relative max-w-xl mx-auto md:max-w-none text-center md:text-left flex flex-col md:flex-row">
            ...
            <div className="md:w-[640px]">
              ...
              <h1 className="h1 font-cabinet-grotesk mb-6" data-aos="fade-right" data-aos-delay="100">
                Celebrate{' '}
                <span className="relative inline-flex text-[#077CB5]">
                  <svg
              ...
              <p className="text-xl text-gray-500 mb-10" data-aos="fade-right" data-aos-delay="200">
                We are a bible believing Church. We create experiences where you and your family can Know God, Grow Closer to Him and Serve Him. Learn about all the different ways you can get connected at the Restoration House Fellowship! We surely want you to discover all that God has for you.
              </p>
              {/* Buttons */}
              <div
              ...
              >
                <div>
                  <Link className="btn text-white bg-[#077CB5] hover:bg-[#1d5977] w-full shadow-sm" to="/signup">
                    Join The Community
                  </Link>
                </div>
                <div>
                  <Link className="btn text-gray-600 bg-white hover:bg-blue-100 hover:text-[#077CB5] w-full shadow-sm" to="/signin">
                    Sign In
                  </Link>
                </div>
              </div>
              ...
              <div className="inline-flex items-center space-x-4 md:space-x-6" data-aos="fade-right" data-aos-delay="400">
                <div>
                  <div className="font-cabinet-grotesk text-2xl font-extrabold"><Link to="/">Sermons</Link> </div>
                ...
                <div>
                  <div className="font-cabinet-grotesk text-2xl font-extrabold"><Link to="/">Events</Link></div>
                ...
                <div>
                  <div className="font-cabinet-grotesk text-2xl font-extrabold"><Link to='/'>Give</Link> </div>
